...
3. 글로 적혀지는 모든 업무 프로세스 과정을 업무용 pc에서 응용 프로그램을 사용한다면 프로세스에 맞게 프로그램을 짜는 순간 수동적으로 하던 반복적 작업을 자동화 할 수 있게될것
4. 
5. main에서 실행-> python 프로그램으로 생성 .py
6. 테스트
7. 테스트 후 py->exe 실행파일로 생성
